    ...
    function priceBTC() {
        $.get("https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=USD,ETH,EUR", function(data) {
            ...
            if (BTCprice > placeholderPrice) {
                ...
                $("#changing-price").html(`<i class="material-icons">trending_up</i><div style="color: green">${placeholderPrice}</div>`)
            } else if (BTCprice < placeholderPrice) {
                placeholderPrice = BTCprice;
                // console.log(BTCprice)
                // console.log(placeholderPrice)
                $("#changing-price").html(`<i class="material-icons" style="color:red">trending_down</i><div style="color: red">${placeholderPrice}</div>`)
